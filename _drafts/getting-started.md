...
For Ubuntu (16.04 - 18.04) and Debian GNU/Linux (8.x-10.x):
...
*The above requirements and build host packages are originally from Yocto Project Quick Build* Copyright 2010-2020 Linux Foundation, under the [Creative Commons Attribution-Share Alike 2.0 UK: England & Wales](https://creativecommons.org/licenses/by-sa/2.0/uk/). Except the part about the cake, we gave you that.*
```
...
- [ ] [Check that you meet build host requirements]()
